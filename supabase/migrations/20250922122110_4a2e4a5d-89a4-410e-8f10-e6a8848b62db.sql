...
BEGIN
    ...
    IF org_id_var IS NOT NULL THEN
        ...
        -- Criar empresas/unidades do Grupo Austa uma por vez
        ...
        IF blog_channel_id IS NOT NULL THEN
        ...
        IF facebook_channel_id IS NOT NULL THEN
            INSERT INTO public.posts (org_id, campaign_id, channel_id, client_id, company_id, status, title, content, publish_at, theme, responsibility, tags)
            VALUES (
                org_id_var,
                campanha_outubro_rosa_id,
        ...
        -- Post 3: Instagram - Institucional IMC
        IF instagram_channel_id IS NOT NULL THEN
            INSERT INTO public.posts (org_id, campaign_id, channel_id, client_id, company_id, status, title, content, publish_at, theme, responsibility, tags)
            VALUES (
                org_id_var,
                NULL,
        ...
        -- Post 4: LinkedIn - Cuidados Paliativos
        IF linkedin_channel_id IS NOT NULL THEN
            INSERT INTO public.posts (org_id, campaign_id, channel_id, client_id, company_id, status, title, content, publish_at, theme, responsibility, tags)
            VALUES (
                org_id_var,
                NULL,
